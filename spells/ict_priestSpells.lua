...
[3] = {spells = {
                [0] = nil,
                [1] = {MindFlay = {name = "Mind Flay", insert = true, isTalentSpell = false, vis = true, id = 15407, duration = 2.5, maxTime = 2.5, icon = ""}},
                [2] = {ShadowWordDeath = {name = "Shadow Word: Death", insert = true, isTalentSpell = false, vis = true, id = 199911, duration = 9, maxTime = 9, icon = ""}},
                [3] = {ShadowWordPain = {name = "Shadow Word: Death", insert = true, isTalentSpell = false, vis = true, id = 589, duration = 14, maxTime = 14, icon = ""}},
