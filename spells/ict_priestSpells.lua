...
[3] = {spells = {
                ...
                [2] = {MindSear = {name = "Mind Sear", insert = true, isTalentSpell = false, vis = true, id = 48045, duration = 4.3, maxTime = 4.3, icon = ""}},
                [3] = {MindFlay = {name = "Mind Flay", insert = true, isTalentSpell = false, vis = true, id = 15407, duration = 2.5, maxTime = 2.5, icon = ""}},
                [4] = {ShadowWordDeath = {name = "Shadow Word: Death", insert = true, isTalentSpell = false, vis = true, id = 32379, duration = 9, maxTime = 9, icon = ""}},
                [5] = {ShadowWordPain = {name = "Shadow Word: Death", insert = true, isTalentSpell = false, vis = true, id = 589, duration = 14, maxTime = 14, icon = ""}},
                [6] = {VampricTouch = {name = "Vampiric Touch", insert = true, isTalentSpell = false, vis = true, id = 34914, duration = 14, maxTime = 14, icon = ""}},
       ...
       buffs = {
                ...
                [6] = {LingeringInsanity  = {name = "Lingering Insanity", insert = true, isTalentSpell = false, vis = true, id = 197937, duration = 0, maxTime = 0, icon = ""}},
                [7] = {VoidEruption = {name = "Void Eruption", insert = true, isTalentSpell = false, vis = true, id = 228260, duration = 15, maxTime = 15, icon = ""}},
                [8] = {ShadowyInsightBuff = {name = "Shadowy Insight", insert = true, isTalentSpell = false, vis = true, id = 124430, duration = 15, maxTime = 15, icon = ""}},
                --[9] = {ShadowyInsightTalent = {name = "Shadowy Insight", insert = false, isTalentSpell = true, vis = false, id = 162452, duration = 15, maxTime = 15, icon = ""}},
