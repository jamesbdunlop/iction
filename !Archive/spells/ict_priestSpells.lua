...
[3] = {spells = {
       ...
       buffs = {
                ...
                [9] = {Dispersion = {name = "Dispersion",
                    insert = true, isTalentSpell = false, vis = true, tid = nil, id = 47585, duration = 6, maxTime = 6, icon = ""}},
                [10] = {Fade = {name = "Fade",
                    insert = true, isTalentSpell = false, vis = true, tid = nil, id = 586, duration = 10, maxTime = 10, icon = ""}},
                },
